...
export const enUS: Translations = {
  ...
  // DevFlow
  devflow: {
    workspaceTitle: "DevFlow Workspace",
    workspaceSubtitle: "Select or create a workspace to start developing",
    workspaceListTitle: "Workspaces",
    workspaceNamePlaceholder: "Workspace name",
    workspacePathPlaceholder: "Workspace path (E:\\path\\to\\project)",
    create: "Create",
    cancel: "Cancel",
    confirmEnter: "Confirm to enter this workspace",
    pathLabel: "Path: ",
    dateLabel: "Created at: ",
    developmentPipeline: "Pipeline",
    enterWorkspace: "Enter Workspace",
    selectWorkspacePrompt: "Please select a workspace on the left",
    newConversation: "New conversation",
    sendMessagePlaceholder: "Ask anything...",
    modePipeline: "Pipeline mode",
    modeChat: "Chat mode",
    selectAgent: "Select an Agent",
    selectAgentPrompt: "Pick an agent to start a direct conversation",
    ...
    reopen: "Reopen",
    close: "Close",
    noChatSessions: "No agent chat sessions",
    noMessages: "No messages yet — start the conversation",
    humanDecision: "Human decision required",
    conversationContinuation: "Conversation continuation",
    historyAccessPolicy: "History access",

...
export const zhCN: Translations = {
  ...
  devflow: {
    ...
    selectAgentPrompt: "选择一个 Agent 开始对话",
    newAgentChat: "新建 Agent 对话",
    chatWithAgent: "与 Agent 对话",
    chatPlaceholder: "向该 Agent 提问…",
    sessionClosed: "会话已关闭",
    reopen: "重新打开",
    close: "关闭",
    noChatSessions: "暂无 Agent 对话",
    noMessages: "暂无消息，开始对话吧",
    humanDecision: "需要人类决策",
    conversationContinuation: "对话延续",
    historyAccessPolicy: "历史可见范围",
